  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-8'>
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription className='font-manrope'>
                {t('settings.appearanceForm.fontDescription')}
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                {t('settings.appearanceForm.themeDescription')}
              </FormDescription>
              <FormMessage />
              <RadioGroup
                ...
                <FormItem>
                  <FormLabel className='[&:has([data-state=checked])>div]:border-primary'>
                    ...
                    <div className='items-center rounded-md border-2 border-muted p-1 hover:border-accent'>
                      <div className='space-y-2 rounded-sm bg-neutral-100 p-2'>
        ...
        <Button type='submit'>{t('settings.appearanceForm.update')}</Button>
      </form>
    </Form>
  )
}
